...
A NOMAD parser plugin for FEFF output files
...
```sh
git clone https://github.com/lwong8010/feff.git
cd feff
...
| Name | E-mail     |
|------|------------|
| Louis Wong | [lwong@iis.u-tokyo.ac.jp](mailto:lwong@iis.u-tokyo.ac.jp)
